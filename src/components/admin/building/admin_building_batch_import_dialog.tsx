...
/**
 * # AdminBuildingBatchImportDialog
 * > 该组件用于创建一个对话框，管理员可以通过这个对话框下载教学楼导入模板并批量导入教学楼信息。
 *
 ...
 * @constructor
 */
export function AdminBuildingBatchImportDialog({show, emit, requestRefresh}: Readonly<{
    show: boolean;
