...
import {Add,  Newlybuild, Search} from "@icon-park/react";
...
import { AdminAddTeacherDialog} from "../../components/admin/admin_teacher_add_dialog.tsx";
import {AdminDeleteTeacherDialog} from "../../components/admin/admin_teacher_delete_dialog.tsx";
import {AdminEditTeacherDialog} from "../../components/admin/admin_teacher_edit_dialog.tsx";
...
export function AdminEducation({ site }: Readonly<{ site: SiteInfoEntity }>): JSX.Element {
    ...
    useEffect(() => {
        document.title = `教务管理 | ${site.name ?? "Frontleaves Technology"}`;
    }, [site.name]);
