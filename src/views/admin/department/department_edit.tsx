                ...
                if (departmentResponse?.output === "Success" && departmentResponse.data) {
                    ...
                    setTimeout(() => {
                        ...
                        const otherData = [
                            ...
                            { name: "originalData", data: departmentEntity }
                        ];
    ...
    useEffect(() => {
        if (aiFormChat.for_back_data) {
            ...
            script.onload = () => {
                ...
                const categoryInput = document.getElementById('unit_category') as HTMLInputElement;
                const typeInput = document.getElementById('unit_type') as HTMLInputElement;
