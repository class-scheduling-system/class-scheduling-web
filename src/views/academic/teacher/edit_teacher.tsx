                        ...
                        <div className="lg:col-span-8 md:col-span-12 sm:col-span-12">
                            <Card
                                ...
                                bodyStyle={{
                                    ...
                                    paddingBottom: '8px' // 减少底部内边距
                                }}
                            >
                                {/!* 表单内容 *!/}
                                <form id="teacher_edit" onSubmit={onSubmit} className="py-1 pb-0 flex flex-col h-full">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {/!* 姓名 *!/}
                                ...
                                >
                                    <ul className="space-y-2 text-gray-700">
                                        <li className="flex items-start">
                                            ...
                                            <span>带<span className="text-red-500">*</span>号的字段为必填项</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-secondary mr-2">•</span>
                                            <span>教师工号是唯一标识，请确保其唯一性</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-secondary mr-2">•</span>
                                            <span>教师必须选择所属单位才能正常使用系统</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-secondary mr-2">•</span>
                                            <span>请确保选择正确的系统用户账号</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-secondary mr-2">•</span>
                                            <span>教师类型可以填写如"专职"、"兼职"等信息</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-secondary mr-2">•</span>
