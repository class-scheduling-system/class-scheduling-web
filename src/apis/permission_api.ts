 ...
 *
 * @returns {Promise<BaseResponse<Page<UserInfoEntity>> | undefined>} - 返回一个Promise，解析为包含权限信息的BaseResponse对象或undefined，如果请求失败或没有有效响应。
 * @throws {Error} 当网络请求过程中遇到问题时抛出异常。
 */
const GetPermissionListAPI = async ():Promise<BaseResponse<PermissionsEntity>  | undefined> => {
    return BaseApi<PermissionsEntity>(
        MethodType.GET,
